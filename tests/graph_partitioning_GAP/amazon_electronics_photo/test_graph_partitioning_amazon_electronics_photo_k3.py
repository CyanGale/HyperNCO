...
if __name__ == "__main__":
    ...
    data_path = Datasets.Graph_Amazon_Photo.path
    ...
    layers = [
        Layer(LayerType.GAT, init_feature_dim, 2048, hidden_channels=4096, num_layers=3, jk="cat", drop_rate=0.8, v2=True, act=GELU()),
        #Layer(LayerType.LINEAR, 1024, 512, use_bn=False, drop_rate=0.2),
        Layer(LayerType.LINEAR, 2048, k, use_bn=True, drop_rate=0.2),
    ]
