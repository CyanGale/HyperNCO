...
if __name__ == "__main__":
    ...
    layers = [
        Layer(LayerType.GAT, init_feature_dim, 1024, hidden_channels=2048, num_layers=2, jk="cat", drop_rate=0, v2=True, act="leaky_relu"),

        Layer(LayerType.LINEAR, 1024, 512, use_bn=False, drop_rate=0.2),
        Layer(LayerType.LINEAR, 512, 256, use_bn=False, drop_rate=0.2),
