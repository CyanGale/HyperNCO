...
if __name__ == "__main__":
    ...
    layers = [
        Layer(LayerType.GAT, init_feature_dim, 64, hidden_channels=256, num_layers=2, jk="cat", drop_rate=0.5, v2=True, act="leaky_relu"),
        Layer(LayerType.LINEAR, 64, k, use_bn=True, drop_rate=0.2),
    ]

    gini_cof_lambda = lambda e, n: (-800 + 0.25 * e) / 1000
    obj_cof_lambda = lambda e, n: e / 900
    cons_cof_lambda = lambda e, n: e / 1000 +e*0.005
