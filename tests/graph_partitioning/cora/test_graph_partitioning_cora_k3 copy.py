...
if __name__ == "__main__":
    ...
    layers = [
        #Layer(LayerType.GAT, init_feature_dim, 512, hidden_channels=1024, num_layers=3, jk="last", drop_rate=0.5, v2=True, act=GELU()),
        #Layer(LayerType.LINEAR, 512, 256, use_bn=False, drop_rate=0),
        #Layer(LayerType.LINEAR, 256, 64, use_bn=False, drop_rate=0),
        #Layer(LayerType.LINEAR, 128, 64, use_bn=False, drop_rate=0),
        #Layer(LayerType.LINEAR, 64, k, use_bn=True, drop_rate=0),
        Layer(LayerType.GAT, init_feature_dim, 512, hidden_channels=1024, num_layers=2, jk="cat", drop_rate=0.5, v2=True, act=GELU()),
        #Layer(LayerType.LINEAR, 256, 64, use_bn=False, drop_rate=0.2),
        #Layer(LayerType.LINEAR, 64, 64, use_bn=False, drop_rate=0.2),
    ...
    gini_cof_lambda = lambda e, n: (-700 + 0.01 * e) / 1000
    obj_cof_lambda = lambda e, n: e / 2000
