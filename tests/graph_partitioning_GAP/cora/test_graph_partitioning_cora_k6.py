...
if __name__ == "__main__":
    # Find Best sol Cora k6: CUTS BLCE 
    ...
    layers = [
        Layer(LayerType.GAT, init_feature_dim, 512, hidden_channels=2048, num_layers=2, jk="last", drop_rate=0.1, v2=True, act=GELU()),
        Layer(LayerType.LINEAR, 512, 256, use_bn=False, drop_rate=0),
        Layer(LayerType.LINEAR, 256, k, use_bn=True, drop_rate=0),
    ]

    gini_cof_lambda = lambda e, n: (-490 + 0.25 * e) / 1000
    obj_cof_lambda = lambda e, n: e / 2000
    cons_cof_lambda = lambda e, n: e / 1400
