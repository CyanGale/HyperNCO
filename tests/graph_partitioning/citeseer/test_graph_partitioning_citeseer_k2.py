...
if __name__ == "__main__":
    ...
    layers = [
        Layer(LayerType.GAT, init_feature_dim, 512, hidden_channels=512, num_layers=3, jk="cat", drop_rate=0.5, v2=True, act="leaky_relu"),
        Layer(LayerType.LINEAR, 512, k, use_bn=True, drop_rate=0.2),
    ]

    gini_cof_lambda = lambda e, n: (-1000 + 0.25 * e) / 1000
